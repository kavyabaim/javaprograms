...
class Student{
	...
	public static List<Student> studentList(){
		...
		list.add(new Student(102, 19, "Riya"));
		list.add(new Student(103, 20, "Meera"));
		list.add(new Student(104, 28, "Meena"));
		list.add(new Student(105, 26, "Paras"));
		return list;
	}
}
public class PredicateEx {
	...
	public static void main(String[] args) {
		...
		Predicate<Student> p2 = s->s.getAge()<25 && s.getName().startsWith("R");
		...
		System.out.println("P1 with allMatch: "+b4);
		
		boolean b5 = list.stream().noneMatch(p1);
		System.out.println("P1 with noneMatch: "+b5);
		
		boolean b6 = list.stream().anyMatch(p1);
		System.out.println("P1 with anyMatch: "+b6);
